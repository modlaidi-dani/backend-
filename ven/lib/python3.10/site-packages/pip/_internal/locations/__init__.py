...
def _looks_like_bpo_44860() -> bool:
    ...
    try:
        ...
        return False
    return unix_user_platlib == "$userite"
...
def get_scheme(
    ...
    for k in SCHEME_KEYS:
        ...
        # using the same $userite for both platlib and purelib. This creates a
        ...
        # but not userite to match the location.
...
def get_prefixed_libs(prefix: str) -> List[str]:
    ...
    # pip will install build backends to the wrong location. This tells user
