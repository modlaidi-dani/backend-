...
def default_user_authentication_rule(user: AuthUser) -> bool:
    # Prior to Django 1.10, inactive user could be authenticated with the
    # default `ModelBackend`.  As of Django 1.10, the `ModelBackend`
    # prevents inactive user from authenticating.  App designers can still
    # allow inactive user to authenticate by opting for the new
    # `AllowAlluserModelBackend`.  However, we explicitly prevent inactive
    # user from authenticating to enforce a reasonable policy and provide
