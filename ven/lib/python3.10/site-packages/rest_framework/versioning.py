...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        re_path(r'^(?P<version>[v1|v2]+)/user/$', user_list, name='user-list'),
        re_path(r'^(?P<version>[v1|v2]+)/user/(?P<pk>[0-9]+)/$', user_detail, name='user-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # urls.py
    urlpatterns = [
        path('v1/', include('user.urls', namespace='v1')),
        path('v2/', include('user.urls', namespace='v2'))
    ]
