...
# Note: We do the following so that user of the framework can use this style:
#
...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def get_fields(self):
        ...
        # This allows user to dynamically modify the fields on a serializer
...
def raise_errors_on_nested_writes(method_name, serializer, validated_data):
    """
    Give explicit errors when user attempt to pass writable nested data.
    ...
    Eg. Suppose we have a `usererializer` with a nested profile. How should
