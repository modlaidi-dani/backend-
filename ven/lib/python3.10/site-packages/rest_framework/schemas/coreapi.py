...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_keys(self, subpath, method, view):
        ...
        /user/{pk}/              ("user", "read"), ("user", "update"), ("user", "delete")
        /user/enabled/           ("user", "enabled")  # custom viewset list action
        /user/{pk}/star/         ("user", "star")     # custom viewset detail action
        /user/{pk}/groups/       ("user", "groups", "list"), ("user", "groups", "create")
        /user/{pk}/groups/{pk}/  ("user", "groups", "read"), ("user", "groups", "update"), ("user", "groups", "delete")
        """
        ...
        if is_custom_action(action):
            # Custom action, eg "/user/{pk}/activate/", "/user/active/"
            mapped_methods = {
        ...
        # Default action, eg "/user/", "/user/{pk}/"
        return named_path_components + [action]
