...
class requeteclientInfo(models.Model):
    client = models.ForeignKey('tiers.Client', on_delete = models.CASCADE, related_name='clients_requetes',   null=True, default=None)  
...
class CourseLivraison(models.Model):
    chauffeur =models.ForeignKey('user.CustomUser', on_delete = models.CASCADE, related_name='mes_courses',   null=True, default=None)
    adresse = models.CharField(max_length=255, null=True, blank=True, default='')
    note = models.CharField(max_length=255, null=True, blank=True, default='')
    ...
    moyen_transport = models.ForeignKey(MoyenTransport, on_delete=models.CASCADE, related_name='courses',   null=False)
    typeCourse = models.CharField(max_length=255, null=True, blank=True, default='') #livraison courier / transporteur
    transporteur = models.CharField(max_length=255, null=True, blank=True, default='')
    bonlivraison = models.ForeignKey('ventes.BonSortie', related_name = "bonL_course", on_delete=models.CASCADE,   null=False)
...
class BlsEnRequeteClient(models.Model):
    requete = models.ForeignKey(requeteclientInfo, related_name = "bonsL_enreq", on_delete=models.CASCADE,   null=False)
    bonlivraison = models.ForeignKey('ventes.BonSortie', related_name = "bonsL_requests", on_delete=models.CASCADE,   null=False)
    modePaiement = models.CharField(max_length=255, null=True, blank=True, default='')
...
class PreparationStock(models.Model):
    ...
    bonEntry = models.ForeignKey('inventory.BonEntry', related_name = "bonsE_preparation", on_delete=models.CASCADE,   null=False)
    datePrep = models.DateTimeField()    
    
class BonTransport(models.Model):
    idBon = models.CharField(max_length=255, null=True, blank=True, default='')
    bonlivraison = models.ForeignKey('ventes.BonSortie', related_name = "bonsL_transports", on_delete=models.CASCADE,   null=False)
    moyen_transport = models.ForeignKey(MoyenTransport, on_delete=models.CASCADE,   null=False)
    ...
    client = models.ForeignKey('tiers.Client', on_delete = models.CASCADE, related_name='clients_bonstransport',   null=True, default=None)
    ...
    user =models.ForeignKey('user.CustomUser', on_delete = models.CASCADE, related_name='mes_bonstransport', blank=False , null=True, default=None)
    etat_livraison =  models.CharField(max_length=255, null=True)
