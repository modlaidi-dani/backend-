...
class ArchivageProduitsEnFacture(models.Model):
    facture_archiv=models.ForeignKey(ArchivageFacture, on_delete = models.CASCADE, related_name='produits_facture_archive')
    produitsfacture=models.ForeignKey(ProduitsEnFacture, on_delete = models.CASCADE)
    FactureNo = models.ForeignKey(Facture, on_delete = models.CASCADE)
    stock = models.ForeignKey('produits.Product', on_delete = models.CASCADE)
