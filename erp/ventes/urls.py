...
router.register('AvoirVenteAncien',AvoirVenteAncienViewset,basename='AvoirVenteAncien')
router.register('produitsEnAvoir',produitsEnAvoirViewset,basename='produitsEnAvoir')
router.register('produitsEnAvoirA',produitsEnAvoirAViewset,basename='produitsEnAvoirA')
